...
import wellbeingVideo from "../assets/videos/wellbeing-video.mp4";
...
export default function Wellbeing() {
  ...
  return <div className="max-w-4xl mx-auto px-4 py-6 space-y-5">
    ...
    <Card className="mt-6 overflow-hidden border-pink-100 shadow-sm">
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-500">
          Pregnancy can be overwhelming sometimes. Take a deep breath and enjoy a
        ...
        <video
          ...
          controls
        >
          <source src={wellbeingVideo} type="video/mp4" />
        </video>
      </div>
    </Card>
  </div>;
