...
export const api = {
  ...
  verifyResetCode: (email, code) => request('/api/auth/verify-reset-code', { method: 'POST', body: JSON.stringify({ email, code }) }),
  resetPassword: (resetToken, password) => request('/api/auth/reset-password', { method: 'POST', body: JSON.stringify({ resetToken, password }) }),
